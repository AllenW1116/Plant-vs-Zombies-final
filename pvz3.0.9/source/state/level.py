...
class Menu():
    def __init__(self):
        self.loadImage(c.MENU)
        self.rect = self.image.get_rect()
        self.rect.x = c.SCREEN_WIDTH - self.rect.w - 10
        self.rect.y = 0
    ...
    def checkMenuClick(self, mouse_pos):
        x, y = mouse_pos
...
class Level(tool.State):
    ...
    def play(self, mouse_pos, mouse_click):
        ...
        if not self.drag_plant and mouse_pos and mouse_click[0]:
            ...
            elif self.menu.checkMenuClick(mouse_pos):
                self.exit = True
    ...
    def addPlant(self):
        ...
        music_name = c.MUSIC_ADD_PLANT + str(music_index)
        tool.SFX[music_name].play()
